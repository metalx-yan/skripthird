...
<div class="container-fluid">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('users.update', $get->id) }}" method="post">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" name="password" value="" class="form-control {{ $errors->has('password') ? 'is-invalid' : ''}}" required>
                    ...
                    <div class="col-md-3">
                        ...
                        <select name="role_id" id="" class="form-control" required>
                            @foreach (App\Role::all() as $item)
                                <option value="{{ $item->id }}" {{ $item->id == $get->role_id ? 'selected' : '' }} >{{ $item->name }}</option>
                            @endforeach
                        </select>
