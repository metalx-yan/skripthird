...
<div class="container-fluid">
    ...
    <div class="card">
        ...
        @endphp
        <div class="card-body">
            <a href="{{ route('peminjamans.create') }}" class="btn btn-primary btn-sm">Tambah Peminjaman</a>
            <br>
            <br>
                    ...
                    @foreach ($all as $item)
                        <tr>
                            ...
                            <td>
                                <div class="row">
                                    <div class="col-md-2">
                                        <a href="{{ route('peminjamans.edit', $item->id ) }}" class="btn btn-warning btn-sm">Edit</a>
                                    </div>
