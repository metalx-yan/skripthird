            ...
            <form action="{{ route('peminjamans.store') }}" method="post">
                ...
                <div class="row">
                    <div class="col-md-3">
                        ...
                        <input type="text" name="no" class="form-control {{ $errors->has('no') ? 'is-invalid' : ''}}" required>
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" name="lama" class="form-control {{ $errors->has('lama') ? 'is-invalid' : ''}}" required>
                    ...
                    <div class="col-md-3">
                        ...
                        <select name="status" class="form-control" id="" required>
                            ...
                            <option value="0">Nggak Active</option>
                        </select>
