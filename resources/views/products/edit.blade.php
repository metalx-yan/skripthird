...
<div class="container-fluid">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('products.update', $get->id) }}" method="post">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" name="kuantitas" value="{{ $get->kuantitas }}" class="form-control {{ $errors->has('kuantitas') ? 'is-invalid' : ''}}" required>
